 ...
 * if any of them fails. They use in-process stubs of OpenVibe.Network, OpenVibe.Billing,
 * OpenVibe.Events and OpenVibe.Live, temp databases and random ports; none needs the network or a
 * running service.
 *
 *   npm test                       # everything
 *   npm test -- overlays import    # only files whose name contains one of the words
 */
'use strict';
